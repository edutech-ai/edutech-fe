...
export const metadata: Metadata = {
  ...
  description:
    "Đăng nhập hoặc đăng ký tài khoản AI EduTech để sử dụng các công cụ AI tạo đề thi, giáo án thông minh.",
  robots: {
    index: true,
    follow: true,
  },
      ...
      <div className="absolute h-full flex items-center justify-center lg:justify-between lg:pl-16 lg:pr-16 w-full z-10">
        <div className="hidden lg:flex text-white lg:order-1 lg:ml-12">
          ...
          <div className="flex flex-col justify-center items-start gap-6 ml-4">
            ...
            <p className="w-96 text-justify text-sm leading-6 opacity-90">
